...
Declaring an action to be preset allows an DF +2 to a perception roll. If the perception roll is successful, the 
character gets to apply their full speed points roll without having. A Preset reaction may only be held for MST 
