...
{
	var url = "http://news.bbc.co.uk/1/hi/help/3223484.stm";
	if (rssURI){document.write('<span class="rsslink"><a href="http://newsrss.bbc.co.uk'+rssURI+'"><img height="15" hspace="8" vspace="0" border="0" width="32" alt="RSS Feed" src="http://newsimg.bbc.co.uk/shared/img/v3/rss_feed.gif" title="Really Simple Syndication" align="left" /></a> | <a href="'+url+'?rss='+rssURI+'" title="What is RSS?">What is RSS?</a></span><br clear="all"/>')}
}
}
