...
BEGIN {
	...
	while ( (getline < "DURSCALE.CFG") == 1) {
		DurScaleSDP[$1] = $2;
	}

	while ( (getline < "CTSCALE.CFG") == 1) {
		CtScaleSDP[$1] = $2;
	}
...
END {
	...
	print "Casting Ease Factor (CEF): " CEF;
	print "Resistance Ease Factor (REF): " (7-RES);
