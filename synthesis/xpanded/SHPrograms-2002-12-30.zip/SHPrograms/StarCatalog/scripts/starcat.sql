...
COPY sc_system FROM '/h/SHPrograms/StarCatalog/temp/starcat.sc_system.import' USING DELIMITERS '|' ;
COPY sc_system_names FROM '/h/SHPrograms/StarCatalog/temp/starcat.sc_system_names.import' USING DELIMITERS '|';
COPY sc_system_location FROM '/h/SHPrograms/StarCatalog/temp/starcat.sc_system_location.import' USING DELIMITERS '|';
COPY sc_system_visuals FROM '/h/SHPrograms/StarCatalog/temp/starcat.sc_system_visuals.import' USING DELIMITERS '|';
COPY sc_system_components FROM '/h/SHPrograms/StarCatalog/temp/starcat.sc_system_components.import' USING DELIMITERS '|';