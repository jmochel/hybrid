...
BEGIN { 
    ...
    print "" > "starcat.names_designation_update.sql";
    print "" > "starcat.names_hd_update.sql";
    print "" > "starcat.names_hr_update.sql";
    print "" > "starcat.names_gliese_update.sql";
    print "" > "starcat.names_bayerflamsteed_update.sql";    
}             
